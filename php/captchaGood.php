    ...
    <main class="bg-gray-100 flex items-center justify-center mt-48">
        <div class="flex justify-center items-center">
            <div class="bg-white p-8 rounded shadow-md w-96">
                <p class="text-2xl font-bold mb-4 text-center">Form sent !</p>
                <a href="index.php" class="bg-orange-200 px-4 py-2 rounded-md hover:bg-orange-400 block w-full text-center">Back</a>
            </div>
        </div>
    </main>
